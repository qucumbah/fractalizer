...
console.warn(`
This is the javascript version of Fractalizer.
It runs much slower than the modern WebGL version, and also lacks many features.
If you want to get the best expirience, update your browser.
`);
